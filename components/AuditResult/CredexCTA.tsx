...
export function CredexCTA({ savingsAmount }: CredexCTAProps) {
  return (
    <div className="glass-card p-6 sm:p-7 border-credex-600/30 bg-gradient-to-br from-credex-950/60 to-navy-950 relative overflow-hidden shadow-lg shadow-credex-950/40">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 relative z-10">
        <div className="space-y-2 max-w-xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-credex-900/50 border border-credex-700/40 text-credex-300 text-xs font-semibold">
          ...
          <p className="text-sm leading-relaxed text-navy-300">
            You are wasting <strong className="text-navy-100">{formatCurrency(savingsAmount)}/month</strong>. 
