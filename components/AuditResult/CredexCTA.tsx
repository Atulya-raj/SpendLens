    ...
    <div className="glass-card p-6 sm:p-7 border-navy-600/40 relative overflow-hidden shadow-lg shadow-navy-950/20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 relative z-10">
        <div className="space-y-2 max-w-xl">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-credex-500/10 border border-credex-500/30 text-credex-600 text-xs font-semibold">
            <span className="w-1.5 h-1.5 rounded-full bg-credex-500 animate-ping" />
            Partner Recommendation
          </div>
          <h3 className="text-xl font-bold text-navy-100 tracking-tight font-display">
